...
class AcmeMockServerBuilderOld {

    private ClientAndServer server; // used to simulate a Let's Encrypt server instance

    AcmeMockServerBuilderOld(ClientAndServer server) {
        server.reset();
        this.server = server;
    }

    public AcmeMockServerBuilderOld addDirectoryResponseBody(String directoryResponseBody) {
        server.when(
                request()
                        .withMethod("GET")
                        .withPath("/directory")
    ...
    public AcmeMockServerBuilderOld addNewNonceResponse(String newNonce) {
        server.when(
                request()
                        .withMethod("HEAD")
    ...
    public AcmeMockServerBuilderOld addNewAccountRequestAndResponse(String expectedNewAccountRequestBody, String newAccountResponseBody,
    ...
    public AcmeMockServerBuilderOld addNewAccountRequestAndResponse(String expectedNewAccountRequestBody, String newAccountResponseBody, String newAccountReplayNonce,
    ...
    public AcmeMockServerBuilderOld updateAccountRequestAndResponse(String expectedUpdateAccountRequestBody, String updateAccountResponseBody, String updateAccountReplayNonce,
    ...
    public AcmeMockServerBuilderOld orderCertificateRequestAndResponse(String expectedOrderCertificateRequestBody, String orderCertificateResponseBody, String orderCertificateReplayNonce,
    ...
    public AcmeMockServerBuilderOld addAuthorizationResponseBody(String expectedAuthorizationUrl, String authorizationResponseBody) {
        server.when(
                request()
                        .withMethod("GET")
    ...
    public AcmeMockServerBuilderOld addChallengeRequestAndResponse(String expectedChallengeRequestBody, String expectedChallengeUrl, String challengeResponseBody,
    ...
    public AcmeMockServerBuilderOld addFinalizeRequestAndResponse(String finalResponseBody, String finalizeReplayNonce,
    ...
    public AcmeMockServerBuilderOld addCertificateRequestAndResponse(String certificateUrl, String certificateResponseBody, int certificateStatusCode) {
        HttpResponse response = response()
                .withHeader("Retry-After", "0")
                .withHeader("Cache-Control", "public, max-age=0, no-cache")
    ...
    public AcmeMockServerBuilderOld addCheckOrderRequestAndResponse(String orderUrl, String checkCertificateResponseBody, int checkCertificateStatusCode) {
        HttpResponse response = response()
                .withHeader("Retry-After", "0")
                .withHeader("Cache-Control", "public, max-age=0, no-cache")
                .withHeader("Content-Type", "application/json")
    ...
    public AcmeMockServerBuilderOld addRevokeCertificateRequestAndResponse(String expectedRevokeCertificateRequestBody, String revokeCertificateReplayNonce, int revokeCertificateStatusCode) {
    ...
    public AcmeMockServerBuilderOld addChangeKeyRequestAndResponse(String expectedChangeKeyRequestBody, String changeKeyResponseBody, String changeKeyReplaceNonce, int changeKeyResponseCode) {
    ...
    public AcmeMockServerBuilderOld addPostRequestAndResponse(String expectedPostRequestBody, String postPath, String responseBody, String replayNonce, String link, String location, int responseCode, boolean useProblemContentType) {
        HttpResponse response = response()
                .withHeader("Retry-After", "0")
                .withHeader("Cache-Control", "public, max-age=0, no-cache")
    ...
    public static ClientAndServer setupTestObtainCertificateWithKeySize(ClientAndServer s, boolean ignoreTOSAcceptance) {
        ...
        return new AcmeMockServerBuilderOld(s)
